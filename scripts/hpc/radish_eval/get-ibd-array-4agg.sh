#!/bin/bash
#SBATCH --job-name=ibd-array-agg4
#SBATCH --output=./err-out/ibd-array-agg4.%A_%a.out
#SBATCH --error=./err-out/ibd-array-agg4.%A_%a.err
...
Rscript ./run-ibd-array-4agg.R ${model_file} ${prefix} ${outdir} ${agg}
